		...
		<tr class="last">
			<td colspan="6" class="actions">
				...
				<div class="buttons">
					...
					<input type="submit" class="light-btn button" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /><input type="submit" class="checkout-button button alt wc-forward btn2" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
