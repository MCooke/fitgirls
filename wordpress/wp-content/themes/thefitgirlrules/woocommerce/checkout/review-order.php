...
<div id="order_review">
	...
	<table class="shop_table">
		...
		<tfoot>
			...
			<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
				...
				<tr class="shipping">
					<th><span class="shipping-title"><?php _e( 'Delivery', 'woocommerce' ); ?></span>
					<p><?php wc_cart_totals_shipping_html(); ?></p></th>
					<td class="last">&nbsp;</td>
				</tr>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt btn3" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
