								...
								foreach ($order as $kk)  {
									...
									echo '<div class="rwp-criterion">';
										echo '<div class="rwp-criterion-text">';
											echo '<span class="rwp-criterion-label" style="line-height: '. $score_size .'px; font-size: '. $score_size .'px;">'. $criteria[$kk] .'</span>';
										echo '</div><!-- /criterion-text -->';

										echo $this->get_stars( $rating['rating_score'][$kk] );
									echo '</div><!-- /criterion -->';
							...
							default:
								...
								foreach ($order as $kk)  {
									...
									echo '<div class="rwp-criterion">';
										echo '<div class="rwp-criterion-text">';
											echo '<span class="rwp-criterion-label" style="line-height: '. $score_size .'px; font-size: '. $score_size .'px;">'. $criteria[$kk] .'</span>';
											echo '<span class="rwp-criterion-score" style="line-height: '. $score_size .'px; font-size: '. $score_size .'px;">'.  RWP_Reviewer::format_number(  $rating['rating_score'][$kk] ) .'</span>';
										echo '</div><!-- /criterion-text -->';

										echo '<div class="rwp-criterion-bar-base">';
											echo $this->get_score_bar( $rating['rating_score'][$kk] );
