 ...
 *----------------------------------------------------------------------------*/
    ...
    public function preferences_users_reviews_captcha_cb( $args ) 
    {
        ...
        echo '<p class="rwp-input-wrapper">'; 
            ...
            echo '<label for="rwp-enable-captcha">'. __('Enable captcha') .'</label>';
        echo '</p>';

        echo '<p class="rwp-input-wrapper">'; 
            echo '<label style="min-width: 150px; display: inline-block; vertical-align: middle;">'. __('ReCaptcha Site Key') .'</label>';
            echo '<input type="text" class="regular-text" name="'. $this->option_name .'[' . $field_id . '][site_key]" value="'. $site_key .'" />';
        echo '</p>';

        echo '<p class="rwp-input-wrapper">'; 
            echo '<label style="min-width: 150px; display: inline-block; vertical-align: middle;">'. __('ReCaptcha Secret Key') .'</label>';
