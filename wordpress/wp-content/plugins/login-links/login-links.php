...
Description: Change WP Admin & WP Login Links
...
if (!class_exists('HC_CustomWPAdminURL')) {
	...
	class HC_CustomWPAdminURL {
		...
		function custom_admin_url() {
			...
			add_settings_field('custom_wpadmin_slug', 'Admin URL', array($this, 'options_page'), 'permalink', 'optional', array('label_for' => 'custom_wpadmin_slug'));
