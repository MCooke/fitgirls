...
if ( $order ) : ?>
	...
	<?php if ( in_array( $order->status, array( 'failed' ) ) ) : ?>
		...
		<ul id="order-process">
			...
			<li class="active"><?php _e('Order Failed', 'lollum'); ?></li>
		</ul>
	...
	<?php else : ?>
		...
		<ul id="order-process">
			<li class="disabled"><?php _e('Shopping Bag', 'lollum'); ?><span class="sep">&gt;</span></li>
			<li class="disabled"><?php _e('Checkout Details', 'lollum'); ?><span class="sep">&gt;</span></li>
			<li class="active"><?php _e('Order Complete', 'lollum'); ?></li>
		</ul>

		<p class="thankyou_text"><?php _e( 'Thank you. Your order has been received.', 'woocommerce' ); ?></p>
